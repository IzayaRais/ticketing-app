...
// Using অন্তরীপ ২১ Farewell Concert as the display name
const EMAIL_FROM = process.env.EMAIL_FROM || '"অন্তরীপ ২১ Farewell Concert" <no-reply@premiumevents.com>';
...
export const generateTicketEmailHTML = (name: string, ticketId: string) => `
  <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
    <div style="background-color: #800000; padding: 40px; text-align: center; border-radius: 12px 12px 0 0;">
      ...
      <p style="color: #fecdd3; margin-top: 5px; font-weight: bold;">অন্তরীপ ২১ FAREWELL CONCERT 2026</p>
    </div>
    <div style="padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px; background-color: #ffffff; line-height: 1.6;">
      ...
      <p>Your registration for the <strong>অন্তরীপ ২১ Farewell Concert</strong> has been successfully confirmed. Get ready for an unforgettable night of music and legacy!</p>
      ...
      <div style="font-size: 11px; color: #94a3b8; margin-top: 40px; text-align: center; border-top: 1px solid #f1f5f9; pt: 20px;">
        অন্তরীপ ২১ Farewell Concert - Premium Event Management System<br>
...
export const generateScannerCredentialsEmailHTML = ({
  ...
  <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto; color: #1f2937;">
    <div style="background: linear-gradient(135deg, #0f172a, #1e293b); padding: 36px; border-radius: 14px 14px 0 0; text-align: center;">
      ...
      <p style="margin: 10px 0 0; color: #cbd5e1; font-size: 13px; letter-spacing: 0.6px;">অন্তরীপ ২১ FAREWELL CONCERT 2026</p>
    </div>
